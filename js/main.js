const translations = {
  es: {
    ...
    hero_text: "Se integra con la API de tu servidor NethSecurity y añade funciones prácticas que no están disponibles en la interfaz web: notificaciones en tiempo real, gestión rápida de reglas, resumen de amenazas, y más — todo sin modificar tu configuración.",
  ...
  en: {
    ...
    hero_text: "It integrates with your NethSecurity API and adds practical features not available in the web interface: real-time notifications, quick rule management, threat summaries, and more — all without altering your server configuration.",
